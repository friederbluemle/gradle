...
class ReadOnlyDependencyCacheWithinContainerTest extends AbstractReadOnlyCacheDependencyResolutionTest {
    ...
    def "can use a read-only cache within a container"() {
        ...
        then:
        result.assertOutputContains("/gradle-home/caches/modules-2/files-2.1/org.readonly/core/1.0/")
        result.assertOutputContains("/gradle-home/caches/modules-2/files-2.1/org.readonly/util/1.0/")
    }
